  ...
  return (
    <div className="bg-white min-h-screen py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Hero Image */}
        <div className="relative w-full h-[300px] md:h-[400px] lg:h-[500px] rounded-[2rem] overflow-hidden mb-20 shadow-sm">
          <Image 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {openings.map((job) => (
              <div 
                key={job.id} 
                className="bg-[#F1F8FF] rounded-2xl p-8 flex flex-col justify-between hover:shadow-md transition-shadow"
              >
                <div>
                ...
                <div className="flex items-center text-slate-700 font-medium text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 mr-1.5 text-slate-500">
