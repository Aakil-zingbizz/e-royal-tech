        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex space-x-8 lg:space-x-12 items-center">
            ...
            <div className="relative group cursor-pointer py-2">
              <Link
                href="/products"
                className={`flex items-center ${isProductsActive ? "text-[#006CB8] font-semibold border-b-2 border-[#006CB8] py-1" : "text-[#333333] group-hover:text-[#006CB8] font-medium transition-colors py-1"}`}
              >
                Products
                <svg
              ...
              <div className="absolute top-full left-0 w-64 bg-white rounded-2xl shadow-xl border border-slate-100 py-3 px-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 z-50">
                ...
                <div className="border-t border-slate-100 my-1 pt-1">
                  <Link
                    href="/products"
                    className="block px-4 py-2 text-xs font-bold text-[#006CB8] hover:underline"
                  >
            ...
            <Link href="/blogs" className={getLinkClass(isBlogsActive)}>
              Blogs
            </Link>
          </nav>
          ...
          <div className="hidden md:flex items-center">
            <Link
              href="/contact"
              className="bg-[#006CB8] text-white px-6 py-2.5 rounded-full font-medium hover:bg-[#005A9C] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#006CB8]"
            >
              Contact Us
            </Link>
          </div>
