...
const Testimonial = () => {
  // We'll use state to manage the active slide for a real carousel feel,
  // even if there's only one dummy text provided for now.
  ...
  const testimonials = [
    ...
    // Adding duplicates for the carousel effect
    {
      quote:
